...
WORKER_CREDENTIAL_PEPPER_VAL=$(generate_secret 48)
...
WORKER_CREDENTIAL_PEPPER_SEALED=$(seal_value "$WORKER_CREDENTIAL_PEPPER_VAL")
...
echo "    WORKER_CREDENTIAL_PEPPER: \"$WORKER_CREDENTIAL_PEPPER_SEALED\""
