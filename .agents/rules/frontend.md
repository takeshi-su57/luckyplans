...
**All frontend UI MUST follow the rules in `.agents/rules/ui-baseline.md`.** That file is the enforced source of truth for visual consistency — HeroUI v3 components, color system, spacing, typography, and patterns.
...
- Violate the UI baseline (`.agents/rules/ui-baseline.md`) — use HeroUI components, not raw HTML + Tailwind
