...
4. Follow the sync protocol in `.agents/rules/ai-framework.md` for `.agents/` file updates
...
5. Follow the sync protocol in `.agents/rules/ai-framework.md` for `.agents/` file updates
