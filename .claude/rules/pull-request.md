...
Resolves https://github.com/takeshi-su57/luckyplans/issues/123
...
4. **Link issues** — use the full issue URL (e.g. `Resolves https://github.com/takeshi-su57/luckyplans/issues/123`) since issues live in a separate repository. Never use shorthand `#123` references
