...
export function GnsIcon({
  ...
  return (
    <svg
      ...
      {...props}
    >
      {/* Official gTrade / Gains Network logo */}
      <path
        fill={`url(#${uid}-a)`}
        d="M40.8 24.1c-2.3-1.6-5.2-.3-5.2-.3L12.4 36.9c-9 4.4-16.5-9.7-4-13.7 0 0 25.8-9.4 32.4.9Z"
      />
      <path
        fill={`url(#${uid}-b)`}
        d="M42.7 27.4c0-.8-.5-2.3-1.9-3.3-5-4.3-17.3-5.5-33.6-.5l18.5-10.5c13.5-2 17 6.4 17 14.3Z"
      />
      <path
        fill={`url(#${uid}-c)`}
        d="m57.1 12.6-.3 40.8c0 9.5-14.2 9.8-14.2 0l.1-26.4c-.4-7.6-3.5-15.7-17-13.9l16-9c7-4 15.4-1 15.4 8.5Z"
      />
      <path
        fill={`url(#${uid}-d)`}
