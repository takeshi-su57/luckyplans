...
export const protocols: Protocol[] = [
  {
    ...
    features: ['Synthetic trading', 'OI hedging', 'Congestion-proof', 'Gasless one-click'],
    backers: ['Chainlink'],
  },
  {
    id: 'gmx',
  ...
  },
  {
    ...
    chains: ['base'],
    features: ['Zero-fee perps', '20% loss protection', 'Positive slippage', 'Tranched liquidity'],
...
export const chains: Chain[] = [
  {
    ...
    description: 'The settlement layer. 292M+ holders, 10 years of uninterrupted uptime.',
  },
  {
    id: 'arbitrum',
    name: 'Arbitrum',
  ...
  },
  {
    ...
    description: 'Coinbase-backed L2. 200ms Flashblocks, $15B+ TVL, 250M gas/sec throughput.',
  },
  {
    id: 'polygon',
    name: 'Polygon',
    ...
    description: '5.3B+ total transactions, 117M+ unique addresses, $1.14B in tokenized RWA.',
  },
  {
    id: 'megaeth',
    name: 'MegaETH',
    ...
    description: 'The first real-time blockchain. Sub-10ms latency, 10+ GGAS/sec throughput.',
  },
];
