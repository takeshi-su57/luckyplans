...
When those conditions appear, add follow-up issues for upload URL issuance, download URL issuance, authorization, retention, artifact reference schema, result reference ingestion, and observability.
