...
Production domains: `app.luckyplans.xyz` (web), `api.luckyplans.xyz` (gateway), `admin.luckyplans.xyz` (admin surfaces), `v0.api.luckyplans.xyz` (legacy API through an in-cluster proxy to host port 9000).
