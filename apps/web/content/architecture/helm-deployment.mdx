...
Legacy service note: `v0.api.luckyplans.xyz` is routed by this Helm chart to the legacy API process on the host via `legacy-v0-api` (`ExternalName: host.k3d.internal`, port `9000`).
