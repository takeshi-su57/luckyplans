...
Docker Compose provides the infrastructure services needed for local dev:
...
| postgresql   | 5432  | Keycloak database (persistent)                 |
...
docker compose down -v     # stop and remove volumes (reset Keycloak DB, Redis)
```
