...
#    Log into Keycloak admin at https://yourdomain.xyz/realms/master
...
| `DB_PASSWORD` | Your database password (when DB is added) |
...
1. Open Keycloak Admin Console (`https://yourdomain.xyz/realms/master` or `http://localhost:8080/admin` for local dev)
