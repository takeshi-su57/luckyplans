...
Open http://localhost:5173 for the standalone landing SPA. The product web app is separate and runs at http://localhost:3000, with product routes and gateway rewrites handled by `apps/web`.
...
| ----------- | ----------------------------- | ------------------------------------- |
| Landing SPA | http://localhost:5173         | Public marketing site                 |
...
1. Open http://localhost:5173 and confirm the landing page loads.
